...
export function ProgressiveTaskList({
    ...
    const TaskItem = ({ task, isFuture = false }: { task: DailyQuest; isFuture?: boolean }) => (
        <View style={[
            styles.taskItem,
            {
            ...
            <View style={styles.taskContent}>
                ...
                {isFuture && (
                    <View style={styles.futureIndicator}>
                        ...
                        <Text style={[styles.futureText, { color: theme.colors.ctaSecondary }]}>
                            Future Task
                        </Text>
                    </View>
                )}
                ...
                <>
                    ...
                    {showFuture && futureTasks.length > 0 && (
                        <View style={styles.futureTasksContainer}>
                            {todayTasks.length > 0 && (
                                <Text style={[styles.motivationText, { color: theme.colors.subtitle }]}>
